        ...
        for utt_idx, utt_segment in enumerate(speaker_utterances):
            ...
            if sample_rate > 0:
                convert_args = [
                    ...
                    "-t",
                    format_timestamp(utt_segment['end_time']-utt_segment['start_time'], always_include_hours=True),
                    "-ar",
                    str(sample_rate),
                    "-threads",
                    str(1),
    ...
    for sentence_idx, sentence_segment in enumerate(sentences):
        ...
        if sample_rate > 0:
            convert_args = [
                ...
                "-t",
                format_timestamp(sentence_segment['end_time']-sentence_segment['start_time'], always_include_hours=True),
                "-ar",
                str(sample_rate),
                "-threads",
                str(1),
